...
| Scaling    | 768                   | 25,000 vectors    | 50,000            | `((50000+25000)*768*(0.01/1000000))     + (25000*768*(0.05/100000000))`   | $0.59 / mo <sup>partial</sup>  |
...
<sup>partial</sup> Part of this usage would fall into the Vectorize usage
included within the Workers Paid plan.
